...
negexpcohort_fits <- brm(formula = negexpcohort_bf, prior = negexpcohort_priors,
...
tictoc::tic()
weibullcohort_fits <- brm(formula = weibullcohort_bf, prior = weibullcohort_priors,
                 data = coweeta_df|>filter(cohort_id %in% c(1,2)), 
                 family = "gaussian", 
                 iter = 5000, chains = 4, cores = 4, warmup = 2000,
                 control= list(adapt_delta = 0.99))
...
marginaleffects::plot_predictions(test_fits, condition = c("days.incubated"), points = 0.7)
